...
nmap \z :tabedit ~/.zshrc
nmap \v :tabedit $MYVIMRC
nmap \w :w!
nmap ]c <Plug>GitGutterNextHunk
xnoremap <silent> a :call TextObjectify(visualmode(),'a')
onoremap <silent> a :call TextObjectify(v:operator,'a')
...
xnoremap <silent> i :call TextObjectify(visualmode(),'i')
onoremap <silent> i :call TextObjectify(v:operator,'i')
nnoremap j gj
nnoremap k gk
nnoremap <silent> u :call repeat#wrap('u',v:count)
...
set runtimepath=~/.vim,~/.vim/bundle/abolish,~/.vim/bundle/ack,~/.vim/bundle/applescript,~/.vim/bundle/bufexplorer,~/.vim/bundle/command-t,~/.vim/bundle/commentary,~/.vim/bundle/emmet,~/.vim/bundle/fugitive,~/.vim/bundle/gist-vim,~/.vim/bundle/gitgutter,~/.vim/bundle/markdown,~/.vim/bundle/repeat,~/.vim/bundle/snipmate,~/.vim/bundle/snippets,~/.vim/bundle/surround,~/.vim/bundle/tabline.vim,~/.vim/bundle/textobjectify,~/.vim/bundle/tlib_vim,~/.vim/bundle/vim-addon-mw-utils,~/.vim/bundle/vim-blade,~/.vim/bundle/vim-colors-solarized,~/.vim/bundle/vim-haml,~/.vim/bundle/webapi-vim,/usr/local/Cellar/macvim/7.4-72/MacVim.app/Contents/Resources/vim/vimfiles,/usr/local/Cellar/macvim/7.4-72/MacVim.app/Contents/Resources/vim/runtime,/usr/local/Cellar/macvim/7.4-72/MacVim.app/Contents/Resources/vim/vimfiles/after,~/.vim/bundle/snipmate/after,~/.vim/after
set shell=zsh\ --login
set shiftwidth=4
set showcmd
set smartcase
...
silent only
cd ~/Sites/ee/eideexcelerate/application
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +170 controllers/admin_reports.php
badd +289 views/admin_reports.php
badd +1 models
badd +5 models/adminreportmdl.php
badd +47 config/routes.php
badd +39 core/MY_Controller.php
badd +1 models/usermdl.php
badd +51 config/database.php
badd +1 models/userlistmdl.php
badd +98 views/user.php
badd +2 views/admin_employee_count.php
args ~/Sites/ee/eideexcelerate/application
edit models/adminreportmdl.php
...
setlocal tabstop=4
setlocal tags=~/Sites/ee/eideexcelerate/.git/php.tags,~/Sites/ee/eideexcelerate/.git/tags,./tags,tags
...
silent! normal! zE
let s:l = 304 - ((31 * winheight(0) + 22) / 44)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
304
normal! 056|
lcd ~/Sites/ee/eideexcelerate/application
tabedit ~/Sites/ee/eideexcelerate/application/controllers/admin_reports.php
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 228 - ((22 * winheight(0) + 22) / 44)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
228
normal! 0
lcd ~/Sites/ee/eideexcelerate/application
tabedit ~/Sites/ee/eideexcelerate/application/views/admin_reports.php
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 370 - ((17 * winheight(0) + 21) / 43)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
370
